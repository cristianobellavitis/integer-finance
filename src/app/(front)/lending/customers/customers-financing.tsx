...
const CustomersFinancing = () => {
  return (
    <MaxWidthWrapper className="my-2">
      <div className="text-center">
        <h3 className="text-3xl font-semibold leading-normal text-primary">
          Looking to finance your real estate development? Fill the form below.
          If you already have a loan and want to request a renovations&apos;
          drawdown, click{" "}
          <Link href="/drawdown" className="underline">
            here
          </Link>
          .
        </h3>
...
export default CustomersFinancing;
